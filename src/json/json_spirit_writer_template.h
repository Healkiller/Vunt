...
namespace json_spirit
{
    ...
    class Generator
    {
        ...
        typedef typename String_type::value_type Char_type;
        typedef typename Object_type::value_type Obj_mvunt_type;
    ...
    private:
        ...
        void output( const Obj_mvunt_type& mvunt )
        {
            output( Config_type::get_name( mvunt ) ); space(); 
            os_ << ':'; space(); 
            output( Config_type::get_value( mvunt ) );
        }
